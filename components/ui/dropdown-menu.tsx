...
function DropdownMenuSubContent({ className, ...props }: React.ComponentPropsWithoutRef<typeof DropdownMenu.SubContent>) {
  return (
...
function DropdownMenuItem({
  ...
  variant = "default",
  ...props
}: React.ComponentPropsWithoutRef<typeof DropdownMenu.Item> & { inset?: boolean; variant?: "default" | "destructive" }) {
  return (
    <DropdownMenu.Item
...
function DropdownMenuRadioItem({ className, children, ...props }: React.ComponentPropsWithoutRef<typeof DropdownMenu.RadioItem>) {
  return (
...
function DropdownMenuSeparator({ className, ...props }: React.ComponentPropsWithoutRef<typeof DropdownMenu.Separator>) {
