...
export const metadata: Metadata = { title: 'Help & Support — BillCraft AI' }
...
function HelpCard({ icon, title, desc, children }: CardProps) {
  return (
    ...
    <div className="p-6 max-w-2xl space-y-8">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Find answers, book a call, or raise a support ticket with our team.
        </p>
      </div>
      ...
      <HelpCard
        ...
        desc="Step-by-step guides covering every feature in BillCraft AI."
      >
        <Link
          href="/docs"
          target="_blank"
